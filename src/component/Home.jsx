...
function Home() {
  return (
    <>
      <div name="Home" className="max-w-screen2xl container mx-auto px-4 md:px-20 my-20">
        <div className="flex flex-col md:flex-row">
          <div className="md:w-1/2 mt-12 md:mt-32 space-y-2 order-2 md:order-1">
            ...
            <p className="text-justify">
              ...
              excepturi place at, distinctio recusandae odio deserunt quibusdam
              quas totam in sa piente voluptatem non reiciendis beatae facere
              aut eum provident quia culpa nemo. Atque qui quas assumenda
              tempora nostrum magnam!
            </p>
            <br />
            {/*social media icons*/}
            <div className="flex flex-col md:flex-row justify-between space-y-6 md:space-y-0 items-center">
              <div className="space-y-2 ">
                ...
                <ul className="flex space-x-5">
                  ...
                  <li>
                    <a href="https://github.com/UDITNARYANSAXENA" target="_blank">
